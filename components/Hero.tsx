        ...
        <div className="lg:col-span-6 relative mt-12 lg:mt-0 order-first lg:order-last group flex justify-center lg:justify-end">
          ...
          <div className="opacity-0 animate-slide-right delay-600 relative z-10 w-full max-w-[495px]">
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-[0_40px_100px_-20px_rgba(109,40,217,0.2)] ring-1 ring-white/50 relative">
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-2xl animate-fade-up delay-800">
                <div className="flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="text-white/60 text-[9px] uppercase tracking-widest font-bold mb-1">Featured Expedition</span>
                    <span className="text-white text-lg serif font-bold">Phang Nga Bay</span>
                  </div>
                  <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#1E1B4B] hover:scale-110 transition-transform">
