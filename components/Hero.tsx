...
const Hero: React.FC = () => {
  ...
  return (
    ...
    // Reduced top padding to pt-24 on mobile to shift content upwards slightly
    <section className="min-h-screen md:min-h-[85vh] pt-24 md:pt-40 px-6 md:px-8 flex items-center relative">
