...
const Hero: React.FC = () => {
  ...
  return (
    ...
    // Reduced top padding to pt-14 (was pt-20) on mobile to shift content upwards by another ~2.5%
    <section className="min-h-screen md:min-h-[85vh] pt-14 md:pt-40 px-6 md:px-8 flex items-center relative">
